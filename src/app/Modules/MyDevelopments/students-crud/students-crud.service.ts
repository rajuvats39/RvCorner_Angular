...
export class StudentCrudService {
  ...
  public createStudent(request: any): Observable<any> {
    return this.httpClient.post<any, any>(this.mydevelopmentGlobalService.studentCRUDApiUrls.createStudent, request);
  }
